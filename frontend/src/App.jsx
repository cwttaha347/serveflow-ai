...
const LegacyInvoiceRedirect = () => {
  ...
  return <Navigate to={`/dashboard/invoices/${id}${suffix}`} replace />;
};
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/provider-onboarding" element={<ProtectedRoute requiredRole="provider"><ProviderOnboarding /></ProtectedRoute>} />

      {/* Legacy payment redirects (Stripe success/cancel URLs) */}
