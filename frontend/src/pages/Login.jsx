...
const Login = () => {
    ...
    const handleRegisterSubmit = async (e) => {
        ...
        if (registerData.role === 'provider' && registerData.category_ids.length === 0) {
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            {categories.map((cat) => (
                                                <button
                                                    ...
                                                    type="button"
                                                    onClick={() => {
                                                        const exists = registerData.category_ids.includes(cat.id);
                                                        setRegisterData({
                                                            ...registerData,
                                                            category_ids: exists
                                                                ? registerData.category_ids.filter((id) => id !== cat.id)
                                                                : [...registerData.category_ids, cat.id],
                                                        });
                                                    }}
