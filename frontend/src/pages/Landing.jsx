...
const Landing = () => {
    ...
    const fetchCategories = async () => {
        ...
        try {
            ...
            setFetchError(error.code === 'ERR_NETWORK'
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {loading ? (
                            ...
                            <div className="col-span-full py-20 flex flex-col items-center justify-center bg-slate-800/20 rounded-[3rem] border border-slate-700/50 backdrop-blur-sm">
                                <Globe className="w-16 h-16 text-slate-600 mb-6 opacity-20" />
                                <h3 className="text-2xl font-black text-slate-400 mb-2">Service Core Unreachable</h3>
                                <p className="text-slate-500 mb-8 max-w-md text-center">{fetchError}</p>
                                <button
                                    onClick={fetchCategories}
                                    className="px-8 py-3 bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 rounded-full font-bold transition-all border border-blue-500/30 flex items-center gap-2 group"
                                >
                                    <Zap className="w-4 h-4 fill-blue-400 group-hover:scale-110 transition-transform" />
                                    Reconnect to API
                                </button>
                            </div>
                        ) : (
