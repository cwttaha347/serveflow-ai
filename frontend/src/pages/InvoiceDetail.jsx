...
const InvoiceDetail = () => {
    ...
    const reconcilePayment = async (sessionId) => {
        ...
        try {
            ...
            showError('Payment confirmation is delayed. Please refresh in a moment.');
        } finally {
            await fetchInvoice();
    ...
    const handleDownload = async () => {
        try {
            ...
            // We use window.open for direct download if token can be passed or just use a link
            // Best way with auth token is fetching as blob
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 px-4 sm:px-6 print:p-0">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                {/* Header */}
                <div className="p-6 sm:p-8 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/20">
                ...
                <div className="p-6 sm:p-8 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12">
                    <div>
                ...
                {/* Totals */}
                <div className="p-6 sm:p-8 bg-slate-50 dark:bg-slate-700/20 border-t border-slate-200 dark:border-slate-700">
