    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <label className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center hover:bg-slate-800 transition-colors shadow-lg shadow-blue-600/20 cursor-pointer">
